...
<form action="" method="post">
  <table width="100%" border="1" bordercolor="ccccff" bgcolor="ccddee" class="9P">
    <tr> 
      <td width="31%">服务器月帐务查询</td>
      <td width="69%" colspan="2"><a href="indexYear.htm">服务器年帐务查询</a></td>
    </tr>
  </table>
</form>
<hr size="1" noshade>
<div align="center"> 
  <table width="100%" border="1" bordercolor="ccccff" bgcolor="ccddee" class="9P">
    <tr> 
      <td width="73%" colspan="2"> <select size="1" name="select3">
        ...
        月 
        <input type="submit" value="月帐务查询" name="B122">
      </td>
    </tr>
  </table>
  <p>&nbsp;</p>
  ...
  <table width="90%" border="1" bordercolor="ccffff" bgcolor="ccddee" class="9P">
    ...
    <tr align="center" class="9P"> 
      ...
      <td nowrap>378.50</td>
      <td nowrap><a href="detailMonth.htm">详细清单</a></td>
    </tr>
    <tr align="center"> 
