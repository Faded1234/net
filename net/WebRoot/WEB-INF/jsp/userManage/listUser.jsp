  ...
  <form action="listUser.htm" method="post" name="userform" >
    <div align="center"> <br/>
      <table width="91%" border=1 align="center" cellpadding="0" cellspacing="0" bordercolor="#ccccff" bgcolor="#ccddee" class="9P" >
        ...
        <tr align="center" > 
          <td height="10"> 正常</td>
          <td> <div align="left"> aaa</div></td>
          <td>aaa</td>
          <td>12345678</td>
          <td>aaa@tarena.com</td>
          <td>2003-01-01</td>
    ...
    <p align="center"> <font color="#000001" size="2">[总用户:3人，当前是：1-1 正常:1，暂停:1 
      删除:1 第1页/共3页 [ <a href="listUser2.htm">下一页</a> ] 转到</font> 
