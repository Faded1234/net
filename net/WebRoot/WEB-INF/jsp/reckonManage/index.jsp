...
<table width="100%" border="1" bordercolor="ccccff" bgcolor="ccddee" class="9P">
  <tr> 
      <td width="12%">账务帐号:</td>  <td width="15%"><input name="textfield" type="text" size="10" maxlength="10"> </td>
      ...
      月 
      <input type="submit" value="查询" name="B122"></td>
  </tr>
</table>
</form>
<hr size="1" noshade>
<div align="center"> 
  <p><span class="green">月帐单</span></p>
  ...
  <table width="100%" border="1" bordercolor="ccffff" bgcolor="ccddee" class="9P">
    ...
    <tr class="9P"> 
      ...
      <td nowrap>50.50</td>
      <td nowrap>80.00</td>
      <td nowrap><div align="center">开通</div></td>
      <td align="center" nowrap><a href="detail.htm">明细</a></td>
    </tr>
  </table>
  <from action="" method="post">
  <p class="9P"><font color="#000001" size="2">[总用户:3人，当前是：1-1 正常:1，暂停:1 删除:1 
    第1页/共3页 [ <a href="index2.htm">下一页</a> ] 转到</font> 
