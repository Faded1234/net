...
<div align="center"> 
  ...
  <table width="100%" border="1" bordercolor="ccffff" bgcolor="ccddee" class="9P">
    <tr bordercolor="ccffff" bgcolor="ccddee" class="9P"> 
      <td width="15%" nowrap>帐务帐号</td>
      <td width="22%" nowrap>登陆时长（小时）</td>
      <td width="10%" nowrap>费用(元)</td>
      <td width="21%" nowrap><div align="center">状态</div></td>
      <td width="32%" align="center" nowrap>明细帐</td>
    </tr>
    <tr> 
      <td nowrap class="pp">ccc</td>
      <td nowrap>0.00</td>
      <td nowrap>0.00</td>
      <td nowrap><div align="center" class="pp">删除</div></td>
      <td align="center" nowrap><a href="detail.htm">明细</a></td>
    </tr>
  </table>
  <from action="" method="post">
  <p class="9P"><font color="#000001" size="2">[总用户:3人，当前是：3-3 正常:1，暂停:1 删除:1 
    第3页/共3页 [ <a href="index2.htm">上一页</a> ] 转到</font> 
